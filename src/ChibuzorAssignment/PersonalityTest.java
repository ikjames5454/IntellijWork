...
public class PersonalityTest {
    ...
    private static String[] arrayEI = new String[6];
    private static int counterEIA;
    private static int counterEIB;
    private static String[] arraySN = new String[5];
    private static int counterSNA;
    private static int counterSNB;
    private static String[] arrayTF = new String[5];
    private static int counterTFA;
    private static int counterTFB;
    private static String[] arrayJP = new String[5];
    private static int counterJPA;
    private static int counterJPB;

    public static void main(String[] args) {
        PersonalityTest.test1();
        PersonalityTest.test2();
        PersonalityTest.test3();
        PersonalityTest.test4();
        PersonalityTest.test5();
        PersonalityTest.test6();
        PersonalityTest.test7();
        PersonalityTest.test8();
        PersonalityTest.test9();
        PersonalityTest.test10();
        PersonalityTest.test11();
        PersonalityTest.test12();
        PersonalityTest.test13();
        PersonalityTest.test14();
        PersonalityTest.test15();
        PersonalityTest.test16();
        PersonalityTest.test17();
        PersonalityTest.test18();
        PersonalityTest.test19();
        PersonalityTest.test20();
        PersonalityTest.array1EI();
        PersonalityTest.array2SN();
        PersonalityTest.array3TF();
        PersonalityTest.array4JP();
    ...
    public static void test1() {
        ...
        if (option.equalsIgnoreCase("A")) {
            ...
            arrayEI[1] = "B: Conserve energy, enjoy one on one";
            counterEIB++;
    ...
    public static void test2() {
        ...
        if (option.equalsIgnoreCase("A")) {
            ...
            arrayEI[2] = "B. More reserved, think to your self";
            counterEIB++;
        } else {
            System.out.println("Expected A or B");
            System.out.println("i know this is an error,Please retry again");
    ...
    public static void test8() {
        ...
        String option = input.nextLine();
        if (option.equalsIgnoreCase("A")) {
            arraySN[2] = " A. standard, usual, convention.";
            counterSNA++;
        } else if (option.equalsIgnoreCase("B")) {
    ...
    public static void test9() {
        System.out.println(" A. focus on here-and-now. \t\t B. look to the future, global  ");
        System.out.println("Choose your option");
        String option = input.nextLine();
        if (option.equalsIgnoreCase("A")) {
            ...
            arraySN[3] = " B. look to the future, global  ";
            counterSNB++;
        } else {
            System.out.println("Expected A or B");
            System.out.println("i know this is an error,Please retry again");
    ...
    public static void test11() {
        System.out.println("  A. Logical, thinking, questioning. \t\t B. Empathetic, feeling,  ");
        System.out.println("Choose your option");
        String option = input.nextLine();
        if (option.equalsIgnoreCase("A")) {
            ...
            arrayTF[0] = " B. Empathetic, feeling";
            counterTFB++;
        } else {
            System.out.println("Expected A or B");
            System.out.println("i know this is an error,Please retry again");
    ...
    public static void array1EI() {
        for (int num = 0; num < arrayEI.length; num++) {
            System.out.println(arrayEI[num]);
        }
        System.out.println("Number of A selected " + counterEIA);
        System.out.println("Number of B selected " + counterEIB + "\n");
    }

    public static void array2SN() {
        for (int num = 0; num < arraySN.length; num++) {
            System.out.println(arraySN[num]);
        }
        System.out.println("Number of A selected " + counterSNA);
        System.out.println("Number of B selected " + counterSNB + "\n");
    }

    public static void array3TF() {
        for (int num = 0; num < arrayTF.length; num++) {
            System.out.println(arrayTF[num]);
        }
        System.out.println("Number of A selected " + counterTFA);
        System.out.println("Number of B selected " + counterTFB + "\n");
    }

    public static void array4JP() {
        for (int num = 0; num < arrayJP.length; num++) {
            System.out.println(arrayJP[num]);
        }
        System.out.println("Number of A selected " + counterJPA);
        System.out.println("Number of B selected " + counterJPB + "\n");
    }
    ...
    public static void personality() {
        ...
        switch (trait) {
            ...
            case "INFJ" ->
                    System.out.println("INFJ personalities(TRAIT) \n\n" +
